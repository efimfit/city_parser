...
class _$RentModelCopyWithImpl<$Res, $Val extends RentModel>
  ...
  @override
  $Res call({
    Object? oneBedroomCenter = null,
    Object? oneBedroomOutside = null,
    Object? threeBedroomsCenter = null,
    Object? threeBedroomsOutside = null,
  }) {
...
/// @nodoc
abstract class _$$_RentModelCopyWith<$Res> implements $RentModelCopyWith<$Res> {
  factory _$$_RentModelCopyWith(
          _$_RentModel value, $Res Function(_$_RentModel) then) =
      __$$_RentModelCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {List<String> oneBedroomCenter,
...
/// @nodoc
class __$$_RentModelCopyWithImpl<$Res>
    extends _$RentModelCopyWithImpl<$Res, _$_RentModel>
    implements _$$_RentModelCopyWith<$Res> {
  __$$_RentModelCopyWithImpl(
      _$_RentModel _value, $Res Function(_$_RentModel) _then)
      : super(_value, _then);
...
class _$_RentModel implements _RentModel {
  ...
  List<String> get threeBedroomsOutside {
    ...
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_threeBedroomsOutside);
  }

  @override
  String toString() {
    return 'RentModel(oneBedroomCenter: $oneBedroomCenter, oneBedroomOutside: $oneBedroomOutside, threeBedroomsCenter: $threeBedroomsCenter, threeBedroomsOutside: $threeBedroomsOutside)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_RentModel &&
            const DeepCollectionEquality()
                .equals(other._oneBedroomCenter, _oneBedroomCenter) &&
            const DeepCollectionEquality()
                .equals(other._oneBedroomOutside, _oneBedroomOutside) &&
            const DeepCollectionEquality()
                .equals(other._threeBedroomsCenter, _threeBedroomsCenter) &&
            const DeepCollectionEquality()
                .equals(other._threeBedroomsOutside, _threeBedroomsOutside));
  }

  @override
  int get hashCode => Object.hash(
      runtimeType,
      const DeepCollectionEquality().hash(_oneBedroomCenter),
      const DeepCollectionEquality().hash(_oneBedroomOutside),
      const DeepCollectionEquality().hash(_threeBedroomsCenter),
      const DeepCollectionEquality().hash(_threeBedroomsOutside));

  @JsonKey(ignore: true)
  @override
  @pragma('vm:prefer-inline')
  _$$_RentModelCopyWith<_$_RentModel> get copyWith =>
      __$$_RentModelCopyWithImpl<_$_RentModel>(this, _$identity);
}
