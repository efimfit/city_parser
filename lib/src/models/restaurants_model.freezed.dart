...
class _$RestaurantsModelCopyWithImpl<$Res, $Val extends RestaurantsModel>
  ...
  @override
  $Res call({
    Object? inexpensiveMeal = null,
    Object? mealForTwoPeople = null,
    Object? mcDonalds = null,
    Object? domesticBeer = null,
    Object? importedBeer = null,
    Object? cappuccino = null,
    Object? pepsi = null,
    Object? water = null,
  }) {
...
class _$_RestaurantsModel implements _RestaurantsModel {
  ...
  @override
  String toString() {
    return 'RestaurantsModel(inexpensiveMeal: $inexpensiveMeal, mealForTwoPeople: $mealForTwoPeople, mcDonalds: $mcDonalds, domesticBeer: $domesticBeer, importedBeer: $importedBeer, cappuccino: $cappuccino, pepsi: $pepsi, water: $water)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._inexpensiveMeal, _inexpensiveMeal) &&
            const DeepCollectionEquality()
                .equals(other._mealForTwoPeople, _mealForTwoPeople) &&
            const DeepCollectionEquality()
                .equals(other._mcDonalds, _mcDonalds) &&
            const DeepCollectionEquality()
                .equals(other._domesticBeer, _domesticBeer) &&
            const DeepCollectionEquality()
                .equals(other._importedBeer, _importedBeer) &&
            const DeepCollectionEquality()
                .equals(other._cappuccino, _cappuccino) &&
            const DeepCollectionEquality().equals(other._pepsi, _pepsi) &&
  ...
  int get hashCode => Object.hash(
      runtimeType,
      const DeepCollectionEquality().hash(_inexpensiveMeal),
      const DeepCollectionEquality().hash(_mealForTwoPeople),
      const DeepCollectionEquality().hash(_mcDonalds),
      const DeepCollectionEquality().hash(_domesticBeer),
      const DeepCollectionEquality().hash(_importedBeer),
      const DeepCollectionEquality().hash(_cappuccino),
      const DeepCollectionEquality().hash(_pepsi),
